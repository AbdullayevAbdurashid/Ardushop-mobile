...
class ZoomAnimation {
  ZoomAnimation(this.controller)
      : dropSize = Tween<double>(begin: 0, end: maximumDropSize).animate(
        ...
        zoomSize = Tween<double>(begin: 0, end: maximumzoomSize).animate(
          CurvedAnimation(
            parent: controller,
