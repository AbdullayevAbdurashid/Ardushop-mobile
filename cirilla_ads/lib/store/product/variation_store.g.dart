...
mixin _$VariationStore on VariationStoreBase, Store {
  ...
  void selectTerm({String? key, String? value}) {
    final $actionInfo = _$_VariationStoreActionController.startAction(name: '_VariationStore.selectTerm');
    try {
      return super.selectTerm(key: key, value: value);
    } finally {
      _$_VariationStoreActionController.endAction($actionInfo);
    }
  }

  @override
  void clear() {
    final $actionInfo = _$_VariationStoreActionController.startAction(name: '_VariationStore.clear');
    try {
      return super.clear();
    } finally {
      _$_VariationStoreActionController.endAction($actionInfo);
  ...
  @override
  dynamic dispose() {
    final $actionInfo = _$_VariationStoreActionController.startAction(name: '_VariationStore.dispose');
    try {
