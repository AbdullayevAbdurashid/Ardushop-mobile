...
mixin _$PostStore on PostStoreBase, Store {
  ...
  @override
  Future<void> refresh() {
    final $actionInfo = _$_PostStoreActionController.startAction(name: '_PostStore.refresh');
    try {
      return super.refresh();
    } finally {
      _$_PostStoreActionController.endAction($actionInfo);
    }
  }
  ...
  void onChanged(
      ...
      bool silent = false}) {
    final $actionInfo = _$_PostStoreActionController.startAction(name: '_PostStore.onChanged');
    try {
