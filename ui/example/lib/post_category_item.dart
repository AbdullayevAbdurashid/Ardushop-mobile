...
class PostCategoryItemScreen extends StatelessWidget {
  const PostCategoryItemScreen({Key? key}) : super(key: key);
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              PostCategoryItemGradient(
                ...
                title:const Text('Castiglione', style: TextStyle(color: Colors.white)),
                count:const Text('43', style: TextStyle(color: Colors.white)),
                onClick: () {},
                width: 245,
              ),
              SizedBox(
