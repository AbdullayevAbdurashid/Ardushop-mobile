...
class IconBoxContainedItem extends IconBoxItem {
  ...
  const IconBoxContainedItem({
    ...
    this.color,
          ...
          key: key,
          colorIconBox: color,
          borderIconBox: border,
          borderRadiusIconBox: borderRadius,
          boxShadowIconBox: boxShadow,
        );
  @override
    ...
    Widget itemWidget = Container(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [icon, const SizedBox(height: 24), title, const SizedBox(height: 16), description],
        ),
      ),
    );
    return onClick != null
