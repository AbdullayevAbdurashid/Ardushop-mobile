...
mixin _$ProductsStore on ProductsStoreBase, Store {
  ...
  Future<List<Product>> refresh({CancelToken? token}) {
    final $actionInfo = _$_ProductsStoreActionController.startAction(name: '_ProductsStore.refresh');
    try {
      return super.refresh(token: token);
    } finally {
      _$_ProductsStoreActionController.endAction($actionInfo);
    }
  }
  ...
  void onChanged(
    ...
    final $actionInfo = _$_ProductsStoreActionController.startAction(name: '_ProductsStore.onChanged');
    try {
      return super
